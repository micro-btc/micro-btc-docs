...
`micro-btc` is a minimal JS library for Bitcoin.
...
<p className="flex h-6">
  <img
    alt="stars"
    src="https://badgen.net/github/stars/micro-btc/microbtc-docs"
    className="inline-block mr-2"
  />
</p>

`micro-stacks` is created and maintained by [Paul Miller](https://github.com/paulmillr), [Fungible Systems](https://fungible.systems), and [Ryan Shea](https://github.com/shea256).